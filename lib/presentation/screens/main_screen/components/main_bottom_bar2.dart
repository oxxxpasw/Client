...
const double _kIndicatorHeight = 53;
const double _kIndicatorWidth = 53;
...
/// [MainNavigationDestination]s).
///
/// {@tool dartpad}
/// This example shows a [MainNavigationBar] as it is used within a [Scaffold]
/// widget. The [MainNavigationBar] has three [MainNavigationDestination] widgets and
...
///
/// {@tool dartpad}
/// This example showcases [MainNavigationBar] label behaviors. When tapping on one
/// of the label behavior options, the [labelBehavior] of the [MainNavigationBar]
/// will be updated.
///
...
///
/// {@tool dartpad}
/// This example shows a [MainNavigationBar] within a main [Scaffold]
...
/// provides local navigation. The example's [MainNavigationBar] has four
/// [MainNavigationDestination] widgets with different color schemes. Its
...
class MainNavigationBar extends StatelessWidget {
  ...
  /// The list of destinations (usually [MainNavigationDestination]s) in this
  /// [MainNavigationBar].
  ///
  ...
  ///
  /// Upon updating [selectedIndex], the [MainNavigationBar] will be rebuilt.
  final ValueChanged<int>? onDestinationSelected;

  /// The color of the [MainNavigationBar] itself.
  ///
  ...
  /// The elevation of the [MainNavigationBar] itself.
  ///
  ...
  /// The height of the [MainNavigationBar] itself.
  ///
  ...
  /// the [MainNavigationDestination] is focused, hovered, or pressed.
...
/// A Material 3 [MainNavigationBar] destination.
///
/// Displays a label below an icon. Use with [MainNavigationBar.destinations].
///
/// See also:
///
///  * [MainNavigationBar], for an interactive code sample.
class MainNavigationDestination extends StatelessWidget {
  ...
  /// in the [MainNavigationBar.destinations].
  ...
  /// [MainNavigationDestination] is selected.
  ///
  ...
  /// The text to display in the tooltip for this [MainNavigationDestination], when
...
/// destination.
///
/// Prefer [MainNavigationDestination] over this widget, as it is a simpler
...
///
/// See [MainNavigationDestination] for an example.
class _NavigationDestinationBuilder extends StatefulWidget {
  /// Builds a destination (icon + label) to use in a Material 3 [MainNavigationBar].
  ...
  /// Builds the icon for a destination in a [MainNavigationBar].
  ///
  ...
  /// Builds the label for a destination in a [MainNavigationBar].
  ///
  /// To animate between unselected and selected, build the icon based on
...
/// Inherited widget for passing data from the [MainNavigationBar] to the
/// [MainNavigationBar.destinations] children widgets.
///
...
class _NavigationDestinationInfo extends InheritedWidget {
  ...
  ///
  /// This is computed by calling [MainNavigationBar.onDestinationSelected]
...
/// Selection Indicator for the Material 3 [MainNavigationBar] and [NavigationRail]
/// components.
///
...
class _NavigationBarDestinationLayout extends StatelessWidget {
  ...
  ///
  /// See [MainNavigationDestination.icon].
  final Widget icon;
  ...
  /// [_NavigationDestinationInfo.selectedAnimation].
  ///
  /// See [MainNavigationDestination.label].
  final Widget label;
...
/// [MainNavigationDestination], based on
...
class _DestinationLayoutAnimationBuilder extends StatelessWidget {
  ...
  /// and fade of the [MainNavigationDestination], either a curve, always
...
/// Tooltip widget for use in a [MainNavigationBar].
///
