...
import 'package:form_builder_image_picker/src/image_source_option.dart';
import 'package:form_builder_image_picker/src/image_source_sheet.dart';
...
class FormBuilderImagePicker2
    extends FormBuilderFieldDecoration<List<dynamic>> {
  ...
  final ValueChanged<ImageSourceBottomSheet Function(BuildContext context)>?
      onTap;
      ...
      ImageSourceOption.gallery,
        ...
        super(
          builder: (FormFieldState<List<dynamic>?> field) {
            final state = field as FormBuilderImagePicker2State;
              ...
              BuildContext context,
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    ImageSourceBottomSheet imageSourceSheetBuilder(
                        BuildContext context) {
                    ...
                    onTap != null
                        ? onTap(imageSourceSheetBuilder)
                        : await showModalBottomSheet<void>(
                            context: state.context,
                            builder: imageSourceSheetBuilder,
                          );
                  },
                );
  ...
  @override
  FormBuilderImagePicker2State createState() => FormBuilderImagePicker2State();
}

class FormBuilderImagePicker2State extends FormBuilderFieldDecorationState<
    FormBuilderImagePicker2, List<dynamic>> {
