...
class DashInputBorder extends InputBorder {
  ...
  @override
  DashInputBorder copyWith({
    BorderSide? borderSide,
    BorderRadius? borderRadius,
    double? gapPadding,
  }) {
    return DashInputBorder(
  ...
  @override
  DashInputBorder scale(double t) {
    return DashInputBorder(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is DashInputBorder) {
      final DashInputBorder outline = a;
      return DashInputBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is DashInputBorder) {
      final DashInputBorder outline = b;
      return DashInputBorder(
    ...
    if (gapStart == null || gapExtent <= 0.0 || gapPercentage == 0.0) {
      canvas.drawPath(
        _dashPath(
          ...
          dashArray: _CircularIntervalList([dashWidth, dashSpace]),
        ),
        paint,
      );
    } else {
  ...
  bool operator ==(Object other) {
    ...
    return other is DashInputBorder &&
