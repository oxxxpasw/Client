...
@RoutePage()
class SplashUpdateScreen extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    Transform.rotate(
                      angle: -math.pi / 12.0,
                      child: Text(
                        context.tr(LocaleKeys.splash_update_label),
                        style: TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Spacer(),
                          Text(
                            context.tr(LocaleKeys.splash_update_descr),
                          ...
                          FilledButtonWithArrow(
                            onPressed: () =>
                                context.read<SplashBloc>().sendUserToAppStore(),
                            label: Text(
                              context.tr(LocaleKeys.splash_update_action),
                            ),
                          ),
                          const Spacer(
                            flex: 5,
